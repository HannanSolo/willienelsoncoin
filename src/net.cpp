...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Willienelsoncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"willienelsoncointools.com", "dnsseed.willienelsoncointools.com"},
    {"willienelsoncoinpool.org", "dnsseed.willienelsoncoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"willienelsoncointools.com", "testnet-seed.willienelsoncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Willienelsoncoin is probably already running."), addrBind.ToString().c_str());
        else
